...
2. Draft L1 (High-Level Strategy): Define the technical approach. Establish the architectural design, key technical decisions, and dependency requirements (use topology, sequence and other visualizations if needed).
...
- Write each stage of plan to file `docs/task/<task-name>/L<X>-PLAN.md`. Split into multiple sub-files when a single file becomes too large and hard to review.
- You are encouraged to doubt user's requests/decisions for better maintainability, simplicity, and readability.
